    ...
    return (
        <div className="flex justify-between px-8 py-4 border-b">
            ...
            <div className="flex items-center">
                ...
                <div onMouseEnter={()=> setIsHovered(true)} onMouseOut={()=>{setTimeout(()=>setIsHovered(false),1500)}} className="bg-slate-200 rounded-full w-10 py-2 text-center cursor-pointer">H</div>
